...
class NetworkTheta:
    ...
    def create_network(self):
        ...
        self.outputs = layers.Dense(1, activation="sigmoid", name='theta_forecast')(f)
    ...
    def train(self):
        self.model.fit([X, other_X], y, epochs=10)
    ...
    def compute_one(m, fun, fun_der_sec):
        ...
        b1 = NetworkTheta.tf_trapz([fin_kc * calls, kc])
        b2 = NetworkTheta.tf_trapz([fin_kp * puts, puts])
